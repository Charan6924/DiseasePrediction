#!/bin/bash
# Hadoop Streaming job — XGBoost inference
#
# Run from the project root on the HPC cluster:
#   bash hadoop/xgboost/run.sh
#
# Prerequisites:
...
hadoop jar "$STREAMING_JAR" \
    -files hadoop/xgboost/mapper.py,hadoop/reducer.py,models/${MODEL_NAME}.pkl \
